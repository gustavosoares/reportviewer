...
NODES_FILES = (
    ...
    '/etc/puppet/manifests/nodes_dev.pp',
    '/etc/puppet/manifests/nodes_homolog.pp',
    '/etc/puppet/manifests/nodes_staging.pp',
    '/etc/puppet/manifests/nodes_prod.pp',
)

ROLES_DIR = "/etc/puppet/manifests/classes/roles"
